...
Add a time-of-day sun simulation that casts accurate shadows for Kingston's latitude (44.23N), with a before/after comparison showing which surrounding buildings lose sunlight when a proposed building is placed.
...
- Latitude: 44.2253 (hardcoded Kingston)
- Day of year (1-365)
