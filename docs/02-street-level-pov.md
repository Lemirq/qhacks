...
- **Performance at street level**: More geometry is visible at eye level. The existing LOD system for vehicles helps, but OSM buildings have no LOD. This should be fine for Kingston's building density.
