...
KingsView is **not** for city planners — they already have professional tools (ArcGIS Urban, AutoCAD) and commission formal studies from licensed consultants. It is **not** for developers — they hire architects and engineers who need precise floor plans and structural analysis.

**KingsView is for the people who currently have no tools at all.**
...
The planning process generates mountains of technical information. KingsView makes that information **visible and accessible** to the people who are actually affected by the decision.
...
| 5. What This Means for Kingston | 1:00 | 7:15 |
| 6. Close | 0:45 | 8:00 |
...
> **SLIDE: A photo of a Kingston public consultation — maybe a crowded room at City Hall, or a rendering taped to a wall.**

"Kingston is growing. Hundreds of development applications move through this building every year. And every one of them triggers the same question from the people who live here: *what is this going to do to my neighborhood?*
...
> **SLIDE: KingsView logo + tagline on a clean slide.**

"KingsView gives residents and councillors the same visibility that planners and developers already have. Describe a building in plain English, place it on a real 3D map of Kingston, and immediately see the impact — shadow, traffic, wind, noise — before the first shovel hits the ground.
...
### 3b. Place on Kingston's Map (0:45)

> Export the building to the map. Place it at a recognizable Kingston location — Princess Street, the waterfront, or near City Hall.

"Now I place it on Kingston's map. This is a real 3D model of the city — 4,776 buildings from OpenStreetMap, real roads, real intersections. I'll drop it right here on [location name]."

> Show the building appear on the map among the existing Kingston buildings. Set a zoning designation.

"I've set the zoning to MU1 — Mixed Use — matching Kingston's Official Plan. The system knows all 76 zoning designations from By-Law 2022-62."

### 3c. Shadow Analysis (0:45)

> Toggle shadow analysis. Drag the time slider from morning to evening.

"Here's where it gets useful for planning. This is a shadow study — the same kind your planning department commissions for major applications. I'm simulating the sun's position for Kingston's latitude through the course of a day."
...
"We're running a live traffic simulation — over 100 vehicles with A* pathfinding on Kingston's actual road network. When I place this building, the system estimates it generates approximately 140 daily vehicle trips based on ITE trip generation standards."
...
"We can also visualize wind acceleration between buildings — the Venturi effect that makes some downtown corridors miserable in winter. Kingston's prevailing wind comes from the west-southwest."
...
"So in under three minutes, we designed a building with our voice, placed it on Kingston's map, ran a shadow study, viewed it from street level, simulated traffic impact, and generated an environmental report. That's KingsView."
...
**Google Gemini** is the intelligence layer. It interprets natural language into building parameters, generates environmental reports grounded in Kingston's geography, and recommends tree species from the city's actual planting program — 40 verified species.

**Three.js** renders the full 3D city. 4,776 buildings, Kingston's road network, real-time traffic with collision detection, and shadow mapping at Kingston's latitude. Everything you just saw runs in a browser — no downloads, no plugins.

**Real Kingston data.** 76 zoning designations from By-Law 2022-62. OpenStreetMap buildings and roads. ITE trip generation standards. Solar position equations for 44 degrees north. SCS curve numbers for stormwater. This isn't a toy with made-up numbers — the calculations use the same standards your planning department uses."

---

## 5. What This Means for Kingston (1:00)

> **SLIDE: Three use cases, each with a one-line description.**

"We built KingsView for three moments in the planning process where the people who matter most are currently left in the dark.

**Public consultations.** Project KingsView at a council meeting. Instead of asking residents to interpret a 2D site plan, show them their actual street — with shadows, traffic, the view from their front door. They can see the impact and respond to something real, not something they have to imagine.

**Council decision-making.** A councillor is voting on a development application next week. They open KingsView, drop the proposed building on the map, and in sixty seconds they can see which residential buildings lose sunlight, which intersections get congested, and what the street looks like at eye level. That's an informed vote.

**Community advocacy.** Right now, when a neighborhood group opposes a development, they write letters. With KingsView, they can show — concretely, visually — what a 10-story building does to their block. The voice interface means anyone can participate. A high school student, a senior, a new Canadian — if you can describe a building in a sentence, you can use this tool. That's a different kind of civic participation."

---

## 6. Close (0:45)

> **SLIDE: Clean final slide — KingsView name, URL, team names.**
...
"Those are professional tools — they're powerful, and planners should keep using them. But they serve the supply side: the people producing developments. KingsView serves the demand side: the people living with the consequences. A resident doesn't need a $700/year ArcGIS license to understand what a building does to their street. They need to describe it, see it, and react to it. That's a fundamentally different user and a fundamentally different tool."

### "Who exactly would use this?"

"Three groups. First, residents at public consultations — instead of staring at a 2D site plan, they see a 3D model on their actual street with real shadow and traffic data. Second, councillors preparing for a vote — they can drop the proposed building on the map and see the impact in sixty seconds instead of reading a 50-page consultant report. Third, community organizations trying to advocate for or against a development — KingsView gives them visual evidence instead of just written objections."
...
| Slide | Content | Notes |
|---|---|---|
| 1 | Title: KingsView + tagline + team names | Clean, no clutter |
...
| 4 | Architecture — simple 3-part diagram (Gemini + Three.js + Kingston Data) | Not technical — just three boxes |
