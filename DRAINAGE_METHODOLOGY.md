...
The analysis uses the **USDA TR-55 method** (the industry standard for small-watershed hydrology) calibrated with **Kingston, Ontario climate data** from Environment and Climate Change Canada.
...
**Estimated parking:**
Based on Kingston's actual zoning rules (By-Law 2022-62, Section 5, Table 5.7):
...
**Lot area:**
If not known, estimated as **2.5x the building footprint** — a mid-range value for Kingston's urban zones where floor area ratios typically run 0.3–0.5 (City of Kingston Official Plan, 2023, Section 3.3).

---

## Section 2: Stormwater Runoff

This section answers: *"During a rainstorm, how much more water runs off the site into Kingston's storm drains?"*
...
"HSG B" = Hydrologic Soil Group B, which represents clay-loam soils typical of Kingston (Farmington and Napanee series, per Ontario Institute of Pedology, "Soils of Frontenac County", 1989).
...
### Kingston design storms

The rainfall amounts come from **Environment and Climate Change Canada (ECCC)** Intensity-Duration-Frequency (IDF) data for Kingston Pumping Station (Climate ID 6104175), 1-hour duration:
...
|-----------|-------|--------|
| Retention per storm | 15 mm | NRC (2024) measured 10–25 mm in Kingston/Ottawa zone; TRCA LID Guide Table 4.6.1 |
...
|------------|----------------|---------------------------------------|
| Hydrologic Soil Group B | Conservative choice for Kingston clay-loam; actual soils range B–C | A geotechnical report would determine this per-site. HSG C would increase all runoff numbers |
| 1-hour storm duration | Standard for small urban lots | Larger sites would model multiple durations |
| Lot area = 2.5x footprint | Mid-range for urban Kingston | A real project uses the actual property boundary from survey/GIS |
...
2. **ECCC.** IDF Curves — Kingston Pumping Station (Climate ID 6104175). https://climate-change.canada.ca/climate-data/short-duration-rainfall-intensity-duration-frequency

3. **City of Kingston.** Zoning By-Law No. 2022-62, Section 5 (Parking). https://www.cityofkingston.ca/residents/property-taxes/zoning
...
11. **City of Kingston (2019).** Stormwater Master Plan.

12. **City of Kingston (2023).** Official Plan, Section 3.3 — Density and Built Form.
