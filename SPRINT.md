# KingsView — Mayor's Innovation Challenge Sprint

**Goal:** Transform KingsView from a hackathon demo into a credible urban planning decision-making tool.
**Timeline:** 2 weeks (presenting in Kingston)
...
**What to build:**
- Directional light matching real sun position for Kingston's latitude (44.23°N)
...
- Factor in prevailing wind direction for Kingston (typically W/SW)
...
If you can demo all five in Kingston, you're not showing a hackathon project — you're showing a planning tool.
