...
6. **Generate an Environmental Report** -- See carbon footprint, noise levels, habitat impact, and community effects analyzed by Gemini.
7. **Ask the Tree Advisor** -- Get tree recommendations from Kingston's official planting program, powered by Gemini.
...
| Voice and Sound | ElevenLabs Text-to-Speech API, ElevenLabs Sound Generation API, Web Speech API |
