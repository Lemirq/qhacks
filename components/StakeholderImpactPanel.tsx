...
export default function StakeholderImpactPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
      <div className="bg-zinc-900/95 backdrop-blur-md rounded-xl shadow-2xl border border-white/10 w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden pointer-events-auto">
        {/* Header */}
